...
import { PlusIcon, PencilIcon, TrashIcon, ReplyIcon } from '@heroicons/react/outline';
...
var TableRow = function TableRow(props) {
  ...
  return /*#__PURE__*/React.createElement("tr", row.getRowProps(), row.cells.map(function (cell, index) {
